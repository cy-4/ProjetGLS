...
public class GameParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GameGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getChoixAccess().getAlternatives_8_1(), "rule__Choix__Alternatives_8_1");
			...
			builder.put(grammarAccess.getChoixAccess().getGroup_7(), "rule__Choix__Group_7__0");
			builder.put(grammarAccess.getChoixAccess().getGroup_8(), "rule__Choix__Group_8__0");
			builder.put(grammarAccess.getChoixAccess().getGroup_8_1_1(), "rule__Choix__Group_8_1_1__0");
			...
			builder.put(grammarAccess.getQteObjetAccess().getQteAssignment_0(), "rule__QteObjet__QteAssignment_0");
			builder.put(grammarAccess.getQteObjetAccess().getObjetAssignment_1(), "rule__QteObjet__ObjetAssignment_1");
			...
			builder.put(grammarAccess.getInteractionAccess().getNameAssignment_0(), "rule__Interaction__NameAssignment_0");
			...
			builder.put(grammarAccess.getChoixAccess().getBonneAssignment_6(), "rule__Choix__BonneAssignment_6");
			builder.put(grammarAccess.getChoixAccess().getObjetConsAssignment_7_1(), "rule__Choix__ObjetConsAssignment_7_1");
			builder.put(grammarAccess.getChoixAccess().getObjetDonAssignment_8_1_0(), "rule__Choix__ObjetDonAssignment_8_1_0");
			builder.put(grammarAccess.getChoixAccess().getConnaisDonAssignment_8_1_1_1(), "rule__Choix__ConnaisDonAssignment_8_1_1_1");
