...
import game.generator.GameGenerator;
import game.parser.antlr.GameAntlrTokenFileProvider;
import game.parser.antlr.GameParser;
import game.parser.antlr.internal.InternalGameLexer;
import game.scoping.GameScopeProvider;
import game.serializer.GameSemanticSequencer;
import game.serializer.GameSyntacticSequencer;
import game.services.GameGrammarAccess;
import game.validation.GameConfigurableIssueCodesProvider;
import game.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "game/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("game.Game");
	}
