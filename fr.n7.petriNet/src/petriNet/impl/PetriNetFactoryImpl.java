...
public class PetriNetFactoryImpl extends EFactoryImpl implements PetriNetFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PetriNetPackage.TRANS_TYPE:
				return createTransTypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case PetriNetPackage.TRANS_TYPE:
				return convertTransTypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public TransType createTransTypeFromString(EDataType eDataType, String initialValue) {
		TransType result = TransType.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertTransTypeToString(EDataType eDataType, Object instanceValue) {
