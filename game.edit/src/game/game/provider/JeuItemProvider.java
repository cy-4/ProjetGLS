...
/**
 * This is the item provider adapter for a {@link game.game.Jeu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JeuItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GamePackage.Literals.JEU__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.JEU__TERRITOIRE);
			childrenFeatures.add(GamePackage.Literals.JEU__EXPLORATEUR);
			childrenFeatures.add(GamePackage.Literals.JEU__ELEMENTSJEU);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__TERRITOIRE,
				 GameFactory.eINSTANCE.createTerritoire()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__EXPLORATEUR,
				 GameFactory.eINSTANCE.createExplorateur()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__ELEMENTSJEU,
				 GameFactory.eINSTANCE.createElementsJeu()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__ELEMENTSJEU,
				 GameFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__ELEMENTSJEU,
				 GameFactory.eINSTANCE.createAvantage()));
		...
		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__ELEMENTSJEU,
				 GameFactory.eINSTANCE.createChemin()));

		newChildDescriptors.add
			(createChildParameter
				(GamePackage.Literals.JEU__ELEMENTSJEU,
				 GameFactory.eINSTANCE.createPersonne()));
