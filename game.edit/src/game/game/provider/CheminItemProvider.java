...
/**
 * This is the item provider adapter for a {@link game.game.Chemin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheminItemProvider extends PlaceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_pred_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_pred_feature", "_UI_Chemin_type"),
				 GamePackage.Literals.CHEMIN__PRED,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSuccPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_succ_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_succ_feature", "_UI_Chemin_type"),
				 GamePackage.Literals.CHEMIN__SUCC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addObligatoirePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chemin_obligatoire_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chemin_obligatoire_feature", "_UI_Chemin_type"),
				 GamePackage.Literals.CHEMIN__OBLIGATOIRE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GamePackage.Literals.CHEMIN__VISIBLE);
			childrenFeatures.add(GamePackage.Literals.CHEMIN__OUVERT);
		}
	...
	public String getText(Object object) {
		String label = ((Chemin)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Chemin_type") :
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == GamePackage.Literals.CHEMIN__VISIBLE ||
			childFeature == GamePackage.Literals.CHEMIN__OUVERT;
