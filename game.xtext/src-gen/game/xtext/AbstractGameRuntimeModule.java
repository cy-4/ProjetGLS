...
import game.xtext.formatting2.GameFormatter;
import game.xtext.generator.GameGenerator;
import game.xtext.parser.antlr.GameAntlrTokenFileProvider;
import game.xtext.parser.antlr.GameParser;
import game.xtext.parser.antlr.internal.InternalGameLexer;
import game.xtext.scoping.GameScopeProvider;
import game.xtext.serializer.GameSemanticSequencer;
import game.xtext.serializer.GameSyntacticSequencer;
import game.xtext.services.GameGrammarAccess;
import game.xtext.validation.GameConfigurableIssueCodesProvider;
import game.xtext.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "game/xtext/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("game.xtext.Game");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("game2");
	}
